 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G=new Map,ce=new Map;function kn(t,e){try{t.container.addComponent(e)}catch(n){x.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function K(t){const e=t.name;if(ce.has(e))return x.debug(`There were multiple attempts to register component ${e}.`),!1;ce.set(e,t);for(const n of G.values())kn(n,t);return!0}function Bn(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $n="firebase-heartbeat-database",Fn=1,j="firebase-heartbeat-store";let ee=null;function $e(){return ee||(ee=tn($n,Fn,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(j)}catch(n){console.warn(n)}}}}).catch(t=>{throw S.create("idb-open",{originalErrorMessage:t.message})})),ee}async function jn(t){try{return await(await $e()).transaction(j).objectStore(j).get(Fe(t))}catch(e){if(e instanceof L)x.warn(e.message);else{const n=S.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});x.warn(n.message)}}}async function Re(t,e){try{const r=(await $e()).transaction(j,"readwrite");await r.objectStore(j).put(e,Fe(t)),await r.done}catch(n){if(n instanceof L)x.warn(n.message);else{const r=S.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});x.warn(r.message)}}}function Fe(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hr(t,e,n){let r=1,s=null,o=null,i=!1,a=0;function c(){return a===2}let l=!1;function g(...w){l||(l=!0,e.apply(null,w))}function d(w){s=setTimeout(()=>{s=null,t(_,c())},w)}function f(){o&&clearTimeout(o)}function _(w,...B){if(l){f();return}if(w){f(),g.call(null,w,...B);return}if(c()||i){f(),g.call(null,w,...B);return}r<64&&(r*=2);let A;a===1?(a=2,A=0):A=(r+Math.random())*1e3,d(A)}let E=!1;function b(w){E||(E=!0,f(),!l&&(s!==null?(w||(a=2),clearTimeout(s),d(0)):w||(a=1)))}return d(0),o=setTimeout(()=>{i=!0,b(!0)},n),b}function dr(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k{constructor(e,n){this._service=e,n instanceof R?this._location=n:this._location=R.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new k(e,n)}get root(){const e=new R(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Xe(this._location.path)}get storage(){return this._service}get parent(){const e=Nr(this._location.path);if(e===null)return null;const n=new R(this._location.bucket,e);return new k(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw lr(e)}}function qr(t,e,n){t._throwIfRoot("uploadBytes");const r=Wr(t.storage,t._location,Je(),new D(e,!0),n);return t.storage.makeRequestWithTokens(r,tt).then(s=>({metadata:s,ref:t}))}function Xr(t){t._throwIfRoot("getDownloadURL");const e=Hr(t.storage,t._location,Je());return t.storage.makeRequestWithTokens(e,tt).then(n=>{if(n===null)throw ar();return n})}function Jr(t,e){const n=xr(t._location.path,e),r=new R(t._location.bucket,n);return new k(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yr(t){return/^[A-Za-z]+:\/\//.test(t)}function Zr(t,e){return new k(t,e)}function nt(t,e){if(t instanceof me){const n=t;if(n._bucket==null)throw or();const r=new k(n,n._bucket);return e!=null?nt(r,e):r}else return e!==void 0?Jr(t,e):t}function Qr(t,e){if(e&&Yr(e)){if(t instanceof me)return Zr(t,e);throw le("To use ref(service, url), the first argument must be a Storage instance.")}else return nt(t,e)}function Se(t,e){const n=e==null?void 0:e[He];return n==null?null:R.makeFromBucketSpec(n,t)}function es(t,e,n,r={}){t.host=`${e}:${n}`,t._protocol="http";const{mockUserToken:s}=r;s&&(t._overrideAuthToken=typeof s=="string"?s:xt(s,t.app.options.projectId))}class me{constructor(e,n,r,s,o){this.app=e,this._authProvider=n,this._appCheckProvider=r,this._url=s,this._firebaseVersion=o,this._bucket=null,this._host=je,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=qn,this._maxUploadRetryTime=Xn,this._requests=new Set,s!=null?this._bucket=R.makeFromBucketSpec(s,this._host):this._bucket=Se(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=R.makeFromBucketSpec(this._url,e):this._bucket=Se(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){ve("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){ve("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const n=await e.getToken();if(n!==null)return n.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new k(this,e)}_makeRequest(e,n,r,s,o=!0){if(this._deleted)return new ur(Ve());{const i=Er(e,this._appId,r,s,n,this._firebaseVersion,o);return this._requests.add(i),i.getPromise().then(()=>this._requests.delete(i),()=>this._requests.delete(i)),i}}async makeRequestWithTokens(e,n){const[r,s]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,n,r,s).getPromise()}}const Ce="@firebase/storage",Oe="0.12.0";/**
 * @license
