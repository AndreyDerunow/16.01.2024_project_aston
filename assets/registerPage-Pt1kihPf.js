 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const B=new Kt("@firebase/app"),cn="@firebase/app-compat",ln="@firebase/analytics-compat",un="@firebase/analytics",hn="@firebase/app-check-compat",dn="@firebase/app-check",fn="@firebase/auth",pn="@firebase/auth-compat",mn="@firebase/database",gn="@firebase/database-compat",_n="@firebase/functions",bn="@firebase/functions-compat",En="@firebase/installations",wn="@firebase/installations-compat",yn="@firebase/messaging",In="@firebase/messaging-compat",Rn="@firebase/performance",An="@firebase/performance-compat",Tn="@firebase/remote-config",Dn="@firebase/remote-config-compat",vn="@firebase/storage",Sn="@firebase/storage-compat",Cn="@firebase/firestore",On="@firebase/firestore-compat",Nn="firebase",xn="10.7.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},S=new Pe("app","Firebase",Pn);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mn=xn;function $e(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ce,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw S.create("bad-app-name",{appName:String(s)});if(n||(n=Ue()),!n)throw S.create("no-options");const o=K.get(s);if(o){if(se(n,o.options)&&se(r,o.config))return o;throw S.create("duplicate-app",{appName:s})}const i=new Ht(s);for(const c of le.values())i.addComponent(c);const a=new Ln(n,r,i);return K.set(s,a),a}function $n(t=ce){const e=K.get(t);if(!e&&t===ce&&Ue())return $e();if(!e)throw S.create("no-app",{appName:t});return e}function L(t,e,n){var r;let s=(r=Bn[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const o=s.match(/\s|\//),i=e.match(/\s|\//);if(o||i){const a=[`Unable to register library "${s}" with version "${e}":`];o&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),B.warn(a.join(" "));return}q(new j(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fn="firebase-heartbeat-database",jn=1,H="firebase-heartbeat-store";let te=null;function Fe(){return te||(te=nn(Fn,jn,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(H)}catch(n){console.warn(n)}}}}).catch(t=>{throw S.create("idb-open",{originalErrorMessage:t.message})})),te}async function Hn(t){try{return await(await Fe()).transaction(H).objectStore(H).get(je(t))}catch(e){if(e instanceof M)B.warn(e.message);else{const n=S.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});B.warn(n.message)}}}async function Ae(t,e){try{const r=(await Fe()).transaction(H,"readwrite");await r.objectStore(H).put(e,je(t)),await r.done}catch(n){if(n instanceof M)B.warn(n.message);else{const r=S.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});B.warn(r.message)}}}function je(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class R{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=R.makeFromUrl(e,n)}catch{return new R(e,"")}if(r.path==="")return r;throw or(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function o(I){I.path.charAt(I.path.length-1)==="/"&&(I.path_=I.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+s+i,"i"),c={bucket:1,path:3};function l(I){I.path_=decodeURIComponent(I.path)}const g="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),f="(/([^?#]*).*)?$",_=new RegExp(`^https?://${d}/${g}/b/${s}/o${f}`,"i"),y={bucket:1,path:3},b=n===He?"(?:storage.googleapis.com|storage.cloud.google.com)":n,E="([^?#]*)",U=new RegExp(`^https?://${b}/${s}/${E}`,"i"),A=[{regex:a,indices:c,postModify:o},{regex:_,indices:y,postModify:l},{regex:U,indices:{bucket:1,path:2},postModify:l}];for(let I=0;I<A.length;I++){const V=A[I],J=V.regex.exec(e);if(J){const ot=J[V.indices.bucket];let Y=J[V.indices.path];Y||(Y=""),r=new R(ot,Y),V.postModify(r);break}}if(r==null)throw sr(e);return r}}class hr{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class re{constructor(e,n){this.data=e,this.contentType=n||null}}function vr(t,e){switch(t){case T.RAW:return new re(Ge(e));case T.BASE64:case T.BASE64URL:return new re(Ke(t,e));case T.DATA_URL:return new re(Cr(e),Or(e))}throw de()}function Ge(t){const e=[];for(let n=0;n<t.length;n++){let r=t.charCodeAt(n);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const o=r,i=t.charCodeAt(++n);r=65536|(o&1023)<<10|i&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function Sr(t){let e;try{e=decodeURIComponent(t)}catch{throw F(T.DATA_URL,"Malformed data URL.")}return Ge(e)}function Ke(t,e){switch(t){case T.BASE64:{const s=e.indexOf("-")!==-1,o=e.indexOf("_")!==-1;if(s||o)throw F(t,"Invalid character '"+(s?"-":"_")+"' found: is it base64url encoded?");break}case T.BASE64URL:{const s=e.indexOf("+")!==-1,o=e.indexOf("/")!==-1;if(s||o)throw F(t,"Invalid character '"+(s?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Dr(e)}catch(s){throw s.message.includes("polyfill")?s:F(t,"Invalid character found")}const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}class qe{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw F(T.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=n[1]||null;r!=null&&(this.base64=Nr(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function Cr(t){const e=new qe(t);return e.base64?Ke(T.BASE64,e.rest):Sr(e.rest)}function Or(t){return new qe(t).contentType}function Nr(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k{constructor(e,n){this._service=e,n instanceof R?this._location=n:this._location=R.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new k(e,n)}get root(){const e=new R(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Je(this._location.path)}get storage(){return this._service}get parent(){const e=xr(this._location.path);if(e===null)return null;const n=new R(this._location.bucket,e);return new k(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw ur(e)}}function Xr(t,e,n){t._throwIfRoot("uploadBytes");const r=Gr(t.storage,t._location,Ye(),new D(e,!0),n);return t.storage.makeRequestWithTokens(r,nt).then(s=>({metadata:s,ref:t}))}function Jr(t){t._throwIfRoot("getDownloadURL");const e=Vr(t.storage,t._location,Ye());return t.storage.makeRequestWithTokens(e,nt).then(n=>{if(n===null)throw cr();return n})}function Yr(t,e){const n=Br(t._location.path,e),r=new R(t._location.bucket,n);return new k(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
